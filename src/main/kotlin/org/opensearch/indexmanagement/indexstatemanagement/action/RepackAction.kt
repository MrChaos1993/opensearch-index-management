...
import org.opensearch.indexmanagement.indexstatemanagement.step.repack.AttemptRollbackIndexSettingsStep
...
class RepackAction(
    ...
    private val waitForRepackCompletionStep = WaitForRepackCompletionStep()
    private val attemptRollbackIndexSettingsStep = AttemptRollbackIndexSettingsStep()
    ...
    private val stepNameToStep: LinkedHashMap<String, Step> =
        linkedMapOf(
            ...
            AttemptRollbackIndexSettingsStep.NAME to attemptRollbackIndexSettingsStep,
        )
    ...
    override fun getStepToExecute(context: StepContext): Step {
        ...
        if (currentStepStatus == Step.StepStatus.COMPLETED) {
            return when (currentStep) {
                ...
                WaitForRepackCompletionStep.NAME -> attemptRollbackIndexSettingsStep
